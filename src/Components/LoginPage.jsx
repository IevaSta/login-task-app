            ...
            <div className="bin-content">
                ...
                <form className="form-Login" action="">
                    ...
                    <label for="pass" className="label">
                        ...
                        <input id="pass" className="input" type="password" placeholder="Password" required />
                    </label>
