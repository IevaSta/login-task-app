            ...
            <div className="bin-content">
                ...
                <form onSubmit={e => login(e)} className="form-Login" action="">
                    <label htmlFor="email" className="label">
                        ...
                        <input ref={emailRef} id="email" className="input" type="email" placeholder="Username or E-mail" required />
                    </label>
                    <label htmlFor="pass" className="label">
                        ...
                        <input ref={passRef} id="pass" className="input" type="password" placeholder="Password" required />
                    </label>
